...
def main(gpu, args):
    ...
    for epoch in range(args.num_epochs):
        ...
        for step, ((x_i, x_j), _) in enumerate(train_loader):
            ...
            if step % 20 == 0 and gpu == 0:
                print(f"Epoch [{epoch+1}/{args.num_epochs}] Step [{step}/{len(train_loader)}]:\tLoss: {loss.item()}")
        ...
        if gpu == 0:
            ...
            if epoch % args.checkpoint_epochs == 0:
                if gpu == 0:
                    ...
                    torch.save(resnet.state_dict(), f"./BYOL_checkpoint/model-{epoch}.pt")
